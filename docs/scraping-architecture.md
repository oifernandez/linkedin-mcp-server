...
| `thread_reply` | `ThreadReplier`, `composer_matches()`, `is_contact_prompt()`, `normalize_reply_message()`, `pick_decline_label()`, `refuse_an_invalid_reply()`, `thread_reply_result()` | `browser-free` |
