...
| `reply_to_thread` | Reply inside an existing messaging thread (InMail included) by `thread_id`, multi-line, with confirmation; `confirm_send=False` is a verified dry run |
